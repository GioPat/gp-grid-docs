...
GP-Grid is designed from the ground up for performance, simplicity, and developer experience.
...
GP-Grid is written entirely in TypeScript with strict type checking. You get:
