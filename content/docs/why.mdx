...
## Lightweight — Everything Included

GP-Grid is significantly smaller than alternatives, and every feature ships for free:

| Library | ReactJS Bundle Size (gzip) | Feature Gating | License |
|---------|-------------------|----------------|---------|
| **GP-Grid** | **~90 kB** | **None — all features included** | Apache 2.0 |
| AG-Grid | ~21 MB+ | Enterprise license required for advanced features (row grouping, pivoting, charts, etc.) | MIT / Commercial |
| Handsontable | ~434 kB+ | Commercial license required for most features | Commercial |

No bloat. No paywalled modules. No enterprise traps. Just what you need — all of it.
