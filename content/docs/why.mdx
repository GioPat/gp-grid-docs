...
| Library | ReactJS Bundle Size (gzip) | Dependencies | Feature Gating | License |
|---------|-------------------|--------------|----------------|---------|
| **GP-Grid** | **~90 kB** | **0** | **None — all features included** | Apache 2.0 |
| AG-Grid | ~21 MB+ | Multiple | Enterprise license required for advanced features (row grouping, pivoting, charts, etc.) | MIT / Commercial |
| Handsontable | ~434 kB+ | Multiple | Commercial license required for most features | Commercial |
