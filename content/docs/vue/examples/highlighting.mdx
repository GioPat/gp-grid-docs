---
title: Highlighting
description: Row, column, and cell highlighting with hover effects
---

# Highlighting

This example demonstrates the v0.7.0 highlighting API using `computeRowClasses`, `computeColumnClasses`, and `computeCellClasses` to create dynamic hover effects.
